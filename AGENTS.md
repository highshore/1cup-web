...
- Styling is Tailwind CSS v4 (theme tokens in `app/globals.css`); prefer theme token utilities, shared layout constants, Supabase helpers, and i18n patterns.
...
- 스타일링은 Tailwind CSS v4입니다(`app/globals.css`의 테마 토큰). 테마 토큰 유틸리티, 공통 레이아웃 상수, Supabase 헬퍼, i18n 패턴을 우선 사용합니다.
