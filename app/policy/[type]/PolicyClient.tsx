  ...
  return (
    <div className={contentClass}>
      ...
      <section className={sectionClass}>
        ...
        <p className={paragraphClass}><strong>멤버십·결제</strong></p>
        <ul>
...
function TermsOfService() {
  return (
    <div className={contentClass}>
      ...
      <section className={sectionClass}>
        <h2 className={sectionTitleClass}>제5조 (서비스 및 멤버십의 제공)</h2>
        <ol>
      ...
      <section className={sectionClass}>
        <h2 className={sectionTitleClass}>제7조 (이용요금 및 결제)</h2>
        <ol>
...
function RefundPolicy() {
  return (
    <div className={contentClass}>
      <section className={sectionClass}>
        <h2 className={sectionTitleClass}>멤버십 기간</h2>
        <p className={paragraphClass}>
      ...
      <section className={sectionClass}>
        <h2 className={sectionTitleClass}>전액 환불</h2>
        <p className={paragraphClass}>
      ...
      <section className={sectionClass}>
        <h2 className={sectionTitleClass}>7일 이후 부분 환불</h2>
        <p className={paragraphClass}>
