...
function TermsOfService() {
  return (
    <Content>
      ...
      <Section>
        <SectionTitle>제5조 (서비스, 멤버십 및 이용 지역)</SectionTitle>
        <ol>
      ...
      <Section>
        <SectionTitle>제7조 (이용요금, 지역별 가격 및 결제)</SectionTitle>
        <ol>
...
function RefundPolicy() {
  return (
    <Content>
      <Section>
        <SectionTitle>멤버십 기간 및 이용 지역</SectionTitle>
        <Paragraph>
      ...
      <Section>
        <SectionTitle>멤버십 전액 환불</SectionTitle>
        <Paragraph>
      ...
      <Section>
        <SectionTitle>멤버십 7일 이후 부분 환불</SectionTitle>
        <Paragraph>
