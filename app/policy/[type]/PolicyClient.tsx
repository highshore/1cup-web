    ...
    <Content>
      ...
      <Section>
        ...
        <ul>
          ...
          <li><strong>멤버십·회차 참여권 및 결제:</strong> 멤버십 가입·갱신·해지, 정기결제, 회차 참여권 구매·사용·만료·환불, 할인·추천인 제도 운영, 거래내역 확인</li>
      ...
      <Section>
        ...
        <Paragraph><strong>멤버십·회차 참여권·결제</strong></Paragraph>
        <ul>
          <li>회원 식별자, 주문번호, 실제 결제금액, 결제상태·수단·일시, 정기결제용 빌링키, 멤버십 시작·종료일, 참여권 잔액·사용·반환·만료 내역, 결제·중단·취소·환불 내역, 할인·추천인 정보</li>
      ...
      <Section>
        ...
        <ul>
          ...
          <li>법령에 따라 보존해야 하는 거래기록과 참여권 원장 내역은 해당 보존기간 동안 별도로 보관합니다. 회원탈퇴 시 직접 식별정보 및 자유기재 사유는 삭제·익명화하고, 금액·주문 연결·발생 시각 등 필요한 감사기록만 유지합니다.</li>
    ...
    <Content>
      ...
      <Section>
        ...
        <ol>
          ...
          <li>“회차 참여권”이란 밋업 1회 신청에 사용할 수 있는 선불형 이용권입니다. 회차 참여권은 멤버십 또는 자동결제가 아니며, 별도 상품으로 구매·관리됩니다.</li>
      ...
      <Section>
        ...
        <ol>
          <li>멤버십 및 회차 참여권의 이용요금, 할인 및 결제주기는 결제 화면에 표시된 내용을 따릅니다.</li>
      ...
      <Section>
        <SectionTitle>제9조의2 (회차 참여권의 사용, 취소 및 환불)</SectionTitle>
        <ol>
          <li>회차 참여권 1회는 밋업 1건의 참가 신청에 사용됩니다. 멤버십이 유효하거나 운영상 무상 참가 대상인 경우에는 참여권이 차감되지 않습니다.</li>
          <li>회차 참여권은 구매 완료 시점부터 180일 동안 유효하며, 유효기간이 지나면 사용되지 않은 잔액은 소멸합니다. 구매 화면과 내 정보에서 잔액 및 이용내역을 확인할 수 있습니다.</li>
          <li>회차 참여권으로 신청한 밋업은 시작 24시간 전까지 취소하면 참여권 1회가 자동 반환됩니다. 그 이후에는 반환되지 않으며, 회사가 밋업을 취소하는 경우에는 신청에 사용한 참여권 1회를 반환합니다.</li>
          <li><strong>전액 환불:</strong> 유효기간 내에 전혀 사용하지 않은 참여권 묶음은 결제한 전액을 환불받을 수 있습니다. 환불이 완료되면 해당 묶음의 참여권은 모두 취소됩니다.</li>
          <li>일부라도 사용했거나 유효기간이 지난 참여권 묶음은 자동 환불 대상이 아닙니다. 다만 회사 귀책 또는 관계 법령에 따른 환불·구제는 관계 법령과 개별 안내에 따릅니다.</li>
...
function RefundPolicy() {
  return (
    <Content>
      ...
      <Section>
        <SectionTitle>회차 참여권</SectionTitle>
        <Paragraph>
          회차 참여권은 멤버십과 별개의 1회성 선불 이용권입니다. 구매 시 표시된 수량이
          한 번에 충전되고 자동결제는 발생하지 않으며, 구매 완료 시점부터 <strong>180일</strong>
          동안 사용할 수 있습니다.
        </Paragraph>
        <ul>
          <li><strong>사용:</strong> 멤버십 또는 무상 참가 대상이 아닌 회원이 밋업을 신청하면 1회가 차감됩니다.</li>
          ...
          <li><strong>전액 환불:</strong> 유효기간 내에 한 번도 사용하지 않은 참여권 묶음은 결제한 전액을 기존 결제수단으로 환불받을 수 있으며, 환불과 동시에 그 묶음의 참여권은 취소됩니다.</li>
          <li><strong>사용·만료 후:</strong> 일부라도 사용했거나 180일 유효기간이 지난 묶음은 자동 환불 대상이 아닙니다. 법령상 더 유리한 권리가 있거나 회사 귀책이 있는 경우에는 그 기준을 우선합니다.</li>
        </ul>
      </Section>
      <Section>
        ...
        <Paragraph>
          ...
          제공하는 기능을 통해 신청할 수 있습니다. 사용하지 않은 회차 참여권 묶음의
          환불은 구매 내역을 기준으로 고객지원에 요청할 수 있습니다. 환불은 원칙적으로 기존 결제수단을
