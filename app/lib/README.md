...
`app/lib` contains shared code used across routes:

- `components/`: global layout, footer, loading screens, and reusable UI.
...
`app/lib`는 여러 라우트에서 함께 사용하는 공통 코드를 담습니다.

- `components/`: 글로벌 레이아웃, footer, 로딩 화면, 재사용 UI.
