const ko = {
  ...
  admin: {
    ...
    marketing: {
      pageTitle: "마케팅",
      settingsTitle: "다음 고파스 게시물",
      settingsDescription:
        "저장된 템플릿과 명확한 게시 일정을 선택하세요. 실행이 완료될 때마다 이전 게시물의 성과도 새로 확인합니다.",
      koreapas: "고파스",
      enabled: "자동 게시 사용",
      scheduleDisabled: "자동 게시 꺼짐",
      templateEditorTitle: "게시물 템플릿",
      templateEditorDescription:
        "저장된 템플릿을 선택하면 아래 입력값이 채워집니다. 내용을 바꾼 뒤 새로운 템플릿으로 저장할 수 있습니다.",
      ...
      scheduleTitle: "게시 일정 (KST)",
      scheduleDescription:
        "자동 게시할 시, 분, 요일을 설정하세요. 크론 문법을 알 필요 없이 같은 방식으로 동작합니다.",
      scheduleMinute: "분",
      scheduleHour: "시",
      scheduleWeekdays: "요일",
      ...
      saveSettings: "일정 저장",
      savingSettings: "저장 중…",
      settingsSaved: "일정을 저장했습니다.",
      settingsError: "일정을 저장하지 못했습니다. 입력값을 확인한 뒤 다시 시도해 주세요.",
      runNow: "지금 실행",
      runningNow: "실행 시작 중…",
      runNowError: "실행을 시작하지 못했습니다. 먼저 완전한 일정을 저장하거나 현재 실행이 끝날 때까지 기다려 주세요.",
      runsTitle: "고파스 실행 기록",
      runs: "실행 ({count})",
      noRuns: "아직 고파스 실행 기록이 없습니다. 일정을 저장해 첫 게시물을 준비하세요.",
