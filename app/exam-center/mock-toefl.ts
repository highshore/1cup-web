...
export function buildMockToeflSteps(): ExamStep[] {
  const steps: ExamStep[] = [
    { id: "welcome", kind: "welcome", section: "Pre-test", title: "Welcome to the TOEFL® iBT Mock Test!", body: ["This mock test is built with sample content for UI review. You will experience the major task types in Reading, Listening, Writing, and Speaking."], actionLabel: "Continue" },
    { id: "hardware", kind: "hardware", section: "Pre-test", title: "Hardware Check", body: ["Before the test begins, we will check your microphone and headset volume.", "Please make sure your headset is on and your microphone is properly positioned."], actionLabel: "Continue" },
    { id: "volume-info", kind: "volume_instructions", section: "Pre-test", title: "Adjusting the Volume", body: ["To adjust the volume, select the Volume control at the top of the screen.", "Move the volume indicator left or right. You can change the volume during the test."], actionLabel: "Continue" },
    { id: "volume-open", kind: "volume_adjusted", section: "Pre-test", title: "Adjusting the Volume", body: ["Use the slider to set a comfortable playback level.", "This is a UI-only mock; no calibration audio is loaded yet."], actionLabel: "Continue" },
    { id: "mic-info", kind: "mic_instructions", section: "Pre-test", title: "Adjusting the Microphone", body: ["Speak into your microphone using your normal tone and volume.", "For best recording results, your voice level should remain in the Good range."], actionLabel: "Continue" },
    { id: "mic-record", kind: "mic_record", section: "Pre-test", title: "Microphone Check", body: ["There are several reasons why I would prefer to live in a large city. Some of the greatest advantages include job opportunities, public transportation, diversity, and entertainment."], actionLabel: "Record" },
