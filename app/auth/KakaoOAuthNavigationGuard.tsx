...
// Keep the browser away from the project's *.supabase.co OAuth callback hostname.
// The same-origin start route redirects directly to Kakao and the callback completes
